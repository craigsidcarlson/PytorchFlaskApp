...
Also included is the pytorch convolutional nuerel net classifier. This code is agnostic and can be rebuilt to any N number of catagories given train and test data is supplied. Once the model is complete the flask application can use it for prediction.
